        ...
        public class TcfV1
        {
...
#if UNITY_IOS
            [DllImport("__Internal")]
            private static extern string ogury_choiceManagerTcfV1_iabString();

            [DllImport("__Internal")]
            private static extern bool ogury_choiceManagerTcfV1_isAccepted(string vendorSlug);

            [DllImport("__Internal")]
            private static extern bool ogury_choiceManagerTcfV1_isPurposeAccepted(string purpose);

            [DllImport("__Internal")]
            private static extern bool ogury_choiceManagerTcfV1_isSpecialFeatureAccepted(int specialFeatures);
#endif
            ...
            public static string IabString
            {
                get
                {
                    ...
                    return "";
#elif UNITY_ANDROID
                    return ChoiceManagerTcfV1.Call<string>("getIABString");
#elif UNITY_IOS
                    return ogury_choiceManagerTcfV1_iabString();
#endif
                }
            }
            ...
            public static bool IsAccepted(string vendorSlug)
            {
                ...
                return false;
#elif UNITY_ANDROID
                return ChoiceManagerTcfV1.Call<bool>("isAccepted", vendorSlug);
#elif UNITY_IOS
                return ogury_choiceManagerTcfV1_isAccepted(vendorSlug);
#endif
            }

            public static bool IsPurposeAccepted(Purpose purpose)
            {
#if UNITY_EDITOR
                return false;
#elif UNITY_ANDROID
                return ChoiceManagerTcfV1.Call<bool>("isPurposeAccepted", purpose.ToString());
#elif UNITY_IOS
                return ogury_choiceManagerTcfV1_isPurposeAccepted(purpose.ToString());
#endif
            }
            ...
            public static bool IsSpecialFeatureAccepted(int specialFeatures)
            {
                ...
                return false;
#elif UNITY_ANDROID
                return ChoiceManagerTcfV1.Call<bool>("isSpecialFeatureAccepted", specialFeatures);
#elif UNITY_IOS
                return ogury_choiceManagerTcfV1_isSpecialFeatureAccepted(specialFeatures);
#endif
            }
